  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(color: col.textBlack),
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: <Widget>[
                            PaymentRecordedElement(
                              userName: 'Charlottte Karlsen',
                              date: '23-08-2018, 8:15pm',
                              amount: '200',
                            ),
                            Divider(
                              thickness: 2,
                  ...
                  Padding(
                      ...
                      child: Consumer<PaymentsProvider>(
                        builder: (context, data, child) => Row(
                            ...
                            //
                            children: map<Widget>(data.readlist, (index, text) {
                              return Container(
                                width: 10,
                                height: 10,
                                margin: EdgeInsets.symmetric(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: data.currentcounter == index
                                        ? col.deepBlue
                                        : col.white),
                              );
                            })),
